...
export default function FeedBackWithSubmission() {
  ...
  return (
    <motion.div
                ...
                {feedback.comments.map((comment, index) => (
                  <motion.li
                    ...
                    <div className="w-10 h-10 rounded-full bg-gray-300 flex items-center justify-center">
                      <img src="/icons/user-placeholder.png" alt="user" className="w-6 h-6" />
                    </div>
                    <div className="flex-1">
                      <div className="flex items-center">
                        <strong className="text-gray-900">{comment.user}</strong>
                        <div className="pr-4"></div>
                        <span className="text-xs text-gray-300">2003.06.05</span>
                      </div>
      ...
      <motion.div
        className={`transition-all duration-500  ${isSidebarOpen ? "mr-[520px]" : "mr-0"}`}
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
