            ...
            <div className="w-full">
              ...
              flex flex-col justify-between">
                    ...
                    <div className="flex justify-between items-center mt-1">
                      ...
                      <p className="text-sm text-gray-400">{formatTimestamp(problem.timestamp)}</p>
                    </div>
            ...
            <table className="w-full border-collapse bg-white shadow-md rounded-2xl overflow-hidden">
              <thead className="bg-gray-200">
                <tr className="border-b-4 border-gray-200 text-gray-800">
                  <th className="px-5 py-4 text-center text-lg font-semibold">문제명</th>
                  <th className="px-5 py-4 text-center text-lg font-semibold">그룹명</th>
                  <th className="px-5 py-4 text-center text-lg font-semibold">문제집 이름</th>
                  <th className="px-5 py-4 text-center text-lg font-semibold">풀이 날짜</th>
                  <th className="px-5 py-4 text-center text-lg font-semibold">행동</th>
                </tr>
              </thead>
              <tbody>
                {sortedProblems.map((problem) => (
                  <tr key={problem.solve_id} className="hover:bg-gray-100">
                    ...
                    <td className="px-5 py-4 text-center">{formatTimestamp(problem.timestamp)}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <button className="w-full py-2 rounded-md text-sm font-medium transition-all duration-300 ease-in-out active:scale-95 bg-mygreen text-white hover:bg-opacity-80">
                        피드백 보기
                      </button>
                    </td>
                  </tr>
