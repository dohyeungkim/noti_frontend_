          ...
          {filteredProblems.map((problem) => (
            ...
            >
              ...
              <Link href={`/feedback/${problem.problemId}`}>
                <button
                  className={`mt-4 w-full text-white py-2 rounded-lg font-medium transition-all duration-200 active:scale-95 ${getButtonColor(problem.status)}`}
                >
                  피드백 보기
                </button>
              </Link>
              ...
              {filteredProblems.map((problem) => (
                <tr key={problem.problemId} className="border-t">
                  ...
                  <td className="p-4 text-center">
                    <Link href={`/feedback/${problem.problemId}`}>
                      <button
                        className={`px-4 py-2 rounded-lg font-medium transition-all duration-200 active:scale-95 text-white ${getButtonColor(problem.status)}`}
                      >
                        피드백 보기
                      </button>
                    </Link>
